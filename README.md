...
Die App zeigt einen ausklappbaren **Quellen-Status** (welche Quelle zuletzt lief, Trefferzahl, Fehler, Aufschlüsselung je Hersteller-Hub, „Stand …") für volle Transparenz.
...
```
                 GitHub Actions (Cron, alle 6 h)
                            ...
                            ▼
   ┌──────────┐   ┌──────────────────┐   ┌────────────────┐
   │ US CPSC  │   │ Hersteller-Hubs (9)       │   │ EU Safety Gate │
   │ REST-API │   │ EDELRID·Petzl·CT·Mammut·  │   │ via r.jina.ai  │
   │          │   │ SKYLOTEC·Black Diamond·   │   │                │
   │          │   │ Beal·DMM·Sterling         │   │                │
   └────┬─────┘   └────────┬─────────┘   └───────┬────────┘
        │                  │                     │
        └──────────────────┼─────────────────────┘
