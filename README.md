...
- **Hersteller-Rückrufseiten** – die Warnhinweis-/Safety-Alert-Hubs der Hersteller: **EDELRID** und **Climbing Technology** direkt, **Petzl**, **Mammut**, **SKYLOTEC**, **Black Diamond** und **Beal** über den `r.jina.ai`-Proxy (JS-gerendert/bot-geschützt). Jeder Hub ist domain-gebunden (keine Fremdmarken-Fehlzuordnung; Skylotec/BD-Seiten verlinken auch Fremdmarken).
